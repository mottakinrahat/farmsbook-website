    ...
    return (
        <div className='mb-[96px]'>
            ...
            <div className='md:flex justify-around items-center ml-4 md:ml-0 '>
                <div className='md:w-[396px] w-[324px] md:h-[544px] h-[412px] mb-5 md:py-[40px] py-2 pr-2 md:pl-[40px] pl-[20px] bg-[#F9E3B9] rounded-lg '>
                ...
                <div className='md:w-[396px] w-[324px] md:h-[544px] h-[412px] mb-5 md:py-[0px] py-2 pr-2 md:pl-[40px] px-[20px] bg-[#F9E3B9] rounded-lg '>
                ...
                <div className='md:w-[396px] w-[324px] md:h-[544px] h-[412px] mb-5 md:py-[40px] pt-2 pr-2 md:pl-[40px] px-[20px] bg-[#F9E3B9] rounded-lg '>
                    <div className='flex flex-col justify-between'>
                        <div className='pr-[25px]'>
