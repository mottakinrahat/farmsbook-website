        ...
        <div>
            <div className='bg-[#F0F2F1] py-2'>
                ...
                <div className='md:flex justify-evenly'>
                    ...
                    <div className='md:w-[496px] w-[327px] text-center md:mx-[16px] md:text-left mx-auto' data-aos="fade-left">
            ...
            <div className='h-[682px] flex flex-col-reverse mt-10 md:mt-0 md:flex-row md:mx-[16px] md:justify-between md:items-center' data-aos="fade-up-right">
            ...
            <div className='md:h-[682px] bg-[#F0F2F1] md:flex  mt-4 py-4 items-center '>
                ...
                <div className='md:w-[496px] w-[327px] text-center md:mx-[16px] mx-auto md:mr-[160] md:text-left' data-aos="fade-down">
