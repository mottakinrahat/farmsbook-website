        ...
        <div className='w-full md:h-[560px] '>
            <div>
                ...
                <div className='text-center md:flex justify-evenly  mb-4  '>
                    <div className='md:w-[388px] w-[324px] italic text-[18px] mx-auto ' data-aos="fade-right">
                    ...
                    <div className='md:w-[388px] w-[324px] italic text-[18px] mx-auto' data-aos="fade-left">
